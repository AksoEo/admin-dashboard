export const notifTemplates = {
    ...
    templateVars: {
        'codeholder.id': '[[CodeholderId]]',
        'codeholder.name': '[[CodeholderName]]',
        'codeholder.oldCode': '[[CodeholderOldCode]]',
        'codeholder.newCode': '[[CodeholderNewCode]]',
        'codeholder.codeholderType': '[[CodeholderType]]',
        'codeholder.hasPassword': '[[CodeholderHasPw]]',
        'codeholder.addressFormatted': '[[CodeholderAddressFmt]]',
        'codeholder.addressLatin.country': '[[CodeholderAddressLatinCountry]]',
        'codeholder.addressLatin.countryArea': '[[CodeholderAddressLatinCountryArea]]',
        'codeholder.addressLatin.city': '[[CodeholderAddressLatinCountryArea]]',
        'codeholder.addressLatin.cityArea': '[[CodeholderAddressLatinCountryArea]]',
        'codeholder.addressLatin.streetAddress': '[[CodeholderAddressLatinCountryArea]]',
        'codeholder.addressLatin.postalCode': '[[CodeholderAddressLatinCountryArea]]',
        'codeholder.addressLatin.sortingCode': '[[CodeholderAddressLatinCountryArea]]',
        'codeholder.feeCountry': '[[CodeholderFeeCountry]]',
        'codeholder.email': '[[CodeholderFeeCountry]]',
        'codeholder.birthdate': '[[CodeholderFeeCountry]]',
        'codeholder.age': '[[CodeholderFeeCountry]]',
        'codeholder.agePrimo': '[[CodeholderFeeCountry]]',
        'codeholder.cellphone': '[[CodeholderFeeCountry]]',
        'codeholder.officePhone': '[[CodeholderFeeCountry]]',
        'codeholder.landlinePhone': '[[CodeholderFeeCountry]]',
        'magazine.id': '[[MagazineId]]',
        'magazine.org': '[[MagazineId]]',
        'magazine.name': '[[MagazineId]]',
        'magazine.description': '[[MagazineId]]',
        'magazine.issn': '[[MagazineId]]',
        'magazine.magazineURL': '[[MagazineId]]',
        'edition.id': '[[MagazineId]]',
        'edition.idHuman': '[[MagazineId]]',
        'edition.date': '[[MagazineId]]',
        'edition.thumbnailURL': '[[MagazineId]]',
        'edition.description': '[[MagazineId]]',
        'edition.editionURL': '[[MagazineId]]',
        'toc.md': '[[MagazineId]]',
        'toc.text': '[[MagazineId]]',
        'toc.html': '[[MagazineId]]',
    },
